# Some other cool thhings we can do with lists 
...
#copying a list with .copy() methood 
...
# the default start and stop are the beginging and the end of the list (Full slice)
...
another_slice4 = key_lime_pie[-1:-3:-1] # specifying a step prameter to tell python how to move onto the next item in the list. list[start:stop;Step]
print(another_slice4) # <--- Side quest 


# ' '.join (list) : Joining a list of string together to form a single string 
